...
public class LoginActivity extends AppCompatActivity {
    ...
    public void showProfileSetup(String token, int userId, String email) {
        ...
        // Open HomePageActivity but tell it to show ProfileSetupFragment
        Intent intent = new Intent(LoginActivity.this, HomePageActivity.class);
        intent.putExtra("open_profile_setup", true); // flag to open fragment
        startActivity(intent);
        finish();
    }
